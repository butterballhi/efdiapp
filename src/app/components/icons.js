// BestiVault SVG Icons — Line-art rounded style (Lucide-inspired)
...
export function VideoIcon({ size = 24, className = '' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function CloudUploadIcon({ size = 24, className = '' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function FlowerIcon({ size = 24, className = '' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <circle cx="12" cy="12" r="3" fill="currentColor" opacity="0.3" />
      <ellipse cx="12" cy="6" rx="2.5" ry="3.5" />
      <ellipse cx="17.5" cy="9.5" rx="2.5" ry="3.5" transform="rotate(60 17.5 9.5)" />
      <ellipse cx="17.5" cy="14.5" rx="2.5" ry="3.5" transform="rotate(120 17.5 14.5)" />
      <ellipse cx="12" cy="18" rx="2.5" ry="3.5" />
      <ellipse cx="6.5" cy="14.5" rx="2.5" ry="3.5" transform="rotate(60 6.5 14.5)" />
      <ellipse cx="6.5" cy="9.5" rx="2.5" ry="3.5" transform="rotate(120 6.5 9.5)" />
    </svg>
  );
}
